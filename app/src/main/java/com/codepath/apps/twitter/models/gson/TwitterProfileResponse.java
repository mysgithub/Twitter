...
public class TwitterProfileResponse {
    ...
    public static TwitterProfileResponse parseJSON(String response){
        Gson gson = new GsonBuilder().create();
        TwitterProfileResponse twitterProfileResponse = gson.fromJson(response, TwitterProfileResponse.class);
