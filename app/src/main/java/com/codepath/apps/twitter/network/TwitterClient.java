...
public class TwitterClient extends OAuthBaseClient {
  ...
  public void postLikeUnLike(AsyncHttpResponseHandler handler, Long tweetId, boolean unLike){
    String apiUrl;
  ...
  public void getTweetsOnSearch(AsyncHttpResponseHandler handler, long maxId, String query){
   ...
   * 	  i.e getApiUrl("statuses/home_timeline.json");
    ...
    public void postMessage(AsyncHttpResponseHandler handler, long userId,  String screenName, String text )
    {
